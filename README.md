...
- **DNS Flow**: Quick access to Windows Network Settings directly from the menu for rapid DNS switching.
- **Clean Menu**: Technical batch files (e.g., `service.bat`, `general.bat`) are automatically filtered out from the "Start" menu.
